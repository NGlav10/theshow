import * as listingUtils from './listingsUtils'
...
describe('listingUtils', () => {
    ...
    describe('sortPlayers', () => {
        it('should return the first player minus the second player', () => {
            ...
            expect(listingUtils.sortPlayers(player1, player2)).toBe(-1)
        })
